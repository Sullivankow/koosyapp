...
import { NotificationsScheduler } from './push-tokens/notifications.scheduler';
...
@Module({
  ...
  providers: [UsersService, PushTokensService, NotificationsService, NotificationsScheduler],
