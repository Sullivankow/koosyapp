      ...
      <View style={styles.overlay}>
        ...
        >
          <View style={[styles.card, { backgroundColor: colors.surface }]}>
            ...
            <Text style={{ color: colors.textSecondary, marginBottom: 12, fontSize: 13 }}>Renseigne tes frais puis valide. La date sera convertie côté backend.</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
              ...
              <TextInput
                ...
                onChangeText={(value) => updateField('date_charge', value)}
                onBlur={() => updateField('date_charge', formatFrenchDate(form.date_charge))}
                keyboardType="numbers-and-punctuation"
              />
              <Text style={{ color: colors.textSecondary, marginTop: -4, marginBottom: 16, fontSize: 12 }}>Le backend convertira cette date avant l'enregistrement.</Text>
            </ScrollView>
